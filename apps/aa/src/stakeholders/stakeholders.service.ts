...
import { AddStakeholdersData, AddStakeholdersGroups, GetAllGroups, GetStakeholdersData, RemoveStakeholdersData, RemoveStakeholdersGroup, UpdateStakeholdersData, UpdateStakeholdersGroups } from "./dto";
...
export class StakeholdersService {
    ...
    async update(payload: UpdateStakeholdersData) {
        const { uuid, designation, district, email, municipality, name, organization, phone } = payload
    ...
    async getAllGroups(payload: GetAllGroups) {
        ...
        return paginate(
            this.prisma.stakeholdersGroups,
            query,
            {
                page,
                perPage
